...
for chr in chrNames:
    bamName = re.split("[/.]", bamPATH)[-2]

    outputPATH = "%s/%s_%s.bam" % (bamSplitDIR, bamName, str(chr))

    CMD = "{samtools} view -h -b {bamPATH} {chrName} > {outputPATH}".format(samtools=samtoolsPATH, bamPATH=bamPATH, chrName=chr, outputPATH=outputPATH)
