...
# Version : v2                                            #
# Modification : shorter the name informarion             #
###########################################################
...
class fil_fa:
    ...
    # Usage
        usage = "       python 'script_path'/fasta_filter_v1.py ../Name_Of_Target ../Input.fasta ../Output_Target_Name.fasta ../Output_other_Name.fasta"
